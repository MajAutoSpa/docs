---
title: "Quickstart"
description: "Get your Mintlify docs running in three steps: clone your repository, install the Mintlify CLI, preview locally, and deploy your first change to production."
---
