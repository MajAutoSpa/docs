---
title: "Cursor setup"
description: "Install the Mintlify skill in the Cursor editor, configure project instructions in AGENTS.md, and use Cursor AI to write and edit docs faster."
icon: "arrow-pointer"
---
