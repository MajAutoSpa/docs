...
description: 'Configure your docs.json file to control your site name, logo, colors, favicon, navigation, topbar links, API playground settings, and footer socials.'
icon: 'gear'
---
