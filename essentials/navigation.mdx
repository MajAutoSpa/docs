...
description: 'Define your sidebar menu in docs.json using groups, nested pages, and folders. Learn the recursive syntax for organizing the navigation of your docs site.'
icon: 'map'
---
