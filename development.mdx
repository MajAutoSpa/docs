...
description: 'Install the Mintlify CLI with npm, run a local preview server for your docs, validate broken links, and troubleshoot common development errors.'
---
